    ...
    <main>
      ...
      <!-- section chi tieu -->
       <section class="chitieu" id="chitieu" style="display: none;">
        <header class="header-chitieu">Quản lý chi tiêu</header>
        ...
        <div class="container-chitieu">
          <div class="top-bar">
            ...
            <div class="search-bar-chitieu">
              <input type="text" placeholder="Tìm kiếm mô tả...">
            </div>
          ...
          <table class="table-chitieu">
            ...
            <tbody>
              <tr>
                ...
                <td>25.000 đ</td>
                <td class="actions">
                  <button onclick="editRow()">✏️</button>
            ...
            <div class="jar-column">
              ...
              <div class="jar-item">
                <div class="jar-header">
                  <input type="checkbox" checked disabled class="jar-checkbox">
                  <img src="../assets/icon/jars/icons8-home-48.png" alt="">
